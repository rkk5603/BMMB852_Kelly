...
usage:
	@echo "# All primary variables: NAME SRR REPORTS N ACC F1 F2 ANN SNPEFFDB"
	@echo "#"
	@echo "# All variables generated from primary variables: REF GFF R1 R2 SAMPLE BG WG VCF "
	@echo "#"
	@echo "# fetch: retrieves genome"
	@echo "#	Input variables"
	@echo "#	-NAME: name for ref genome NAME.fasta and NAME.gff"
	@echo "#	-ACC: accession number for reference "
	@echo "#	Generated variables"
	@echo "#	-REF: path to send NAME.fasta file"
	@echo "#	-GFF: path to send NAME.gff file"
	@echo "#"
	@echo "# fastq: retrieves sequencing reads from a provided SRR"
	@echo "#	Input variables"
	@echo "#	-N: Number of reads to download"
	@echo "#	-SRR: SRR ID for retrieving reads from SRA "
	@echo "#	Generated variables"
	@echo "#	-R1: path to send forward reads SRR.fastq file"
	@echo "#	-R2: path to send reverse reads SRR.fastq file"
	@echo "#"
	@echo "# fastqc: performs QC and generates multiQC report"
	@echo "#	Input variables"
	@echo "#	-R1: path to forward reads SRR.fastq file"
	@echo "#	-R2: path to reverse reads SRR.fastq file"
	@echo "#	Generated variables"
	@echo "#	-REPORTS: directory to send QC reports"
	@echo "#"
	@echo "# align: performs an alignment to the reference genome and generates a BAM file"
	@echo "#	Input variables"
	@echo "#	-REF: path to NAME.fasta file"
	@echo "#	-R1: path to forward reads SRR.fastq file"
	@echo "#	-R2: path to reverse reads SRR.fastq file"
	@echo "#	Generated variables"
	@echo "#	-BAM: path to SRR.bam file"
	@echo "#"
	...
	@echo "#	Input variables"
	@echo "#	-REF: path to reference NAME.fasta file"
	@echo "#	-BAM: path to SAMPLE.bam"
	@echo "#	Generated variables"
	@echo "#	-BG: path to temporary SAMPLE.bedgraph file"
	@echo "#	-BW: path to send SAMPLE.bw file"
	@echo "#"
	@echo "# bcf: calls variants with bcftools"
	@echo "#	Input variables"
	@echo "#	-REF: path to reference NAME.fasta file"
	@echo "#	-BAM: path to SAMPLE.bam file"
	@echo "#	Generated variables"
	@echo "#	-VCF: path to called variants SAMPLE.vcf.gz file"
	@echo "#"
	@echo "# effect_db: retrieves prebuilt database for use with snpEff"
	@echo "#	Input variables"
	@echo "#	-SNPEFFDB: name of database"
	@echo "#"
	@echo "# effect: predicts variant effects with snpEff"
	@echo "#	Input variables"
	@echo "#	-SNPEFFDB: name of database"
	@echo "#	-VCF: path to SAMPLE.vcf.gz variant file"
	@echo "#	Generated variables"
	@echo "#	-ANN: path to send annotated variants .vcf file"
	@echo "#"
